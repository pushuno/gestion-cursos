...
@section('content')
     <div class="row">
        <div class="col-md-6">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form action=" {{ route('cursos.add') }} " method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" min="1" class="form-control mb-3 {{ $errors->has("duracion_horas")?"is-invalid":'' }}" name="duracion_horas" value="{{ old('duracion_horas') }}" autocomplete="off" >
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="descripcion" rows="10" cols="40" class="form-control mb-3 {{ $errors->has("descripcion")?"is-invalid":'' }}">{{ old('descripcion') }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Descripción cantidad de clases (*)</label>
                                <textarea name="duracion_leyenda" rows="10" cols="40" class="form-control mb-3 {{ $errors->has("duracion_leyenda")?"is-invalid":'' }}">{{ old('duracion_leyenda') }}</textarea>
                            </div>
                        </div>
                    </div>
