     ...
     <div class="row">
        <div class="col-md-12 col-12">
            ...
            <div class="card-header">
                <h3 class="card-title">Nuevo Capacitador</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <form action=" {{ route('capacitadores.add') }} " method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Oficina</label>
                                <input type="text" class="form-control mb-3 {{ $errors->has("oficina")?"is-invalid":'' }}" name="oficina" value="{{ old('oficina') }}" autocomplete="off" >
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
